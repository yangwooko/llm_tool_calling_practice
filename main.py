...
def main():
    ...
    test_questions = [
        ...
        # "부산 날씨와 10 + 5 계산을 해줘",
        "건축법에서 경미한 사항의 변경에 대해 알려줘. 단, 관련된 법령의 이름이나 조항 번호를 포함하고 법령 내용을 인용하는 방식으로 설명해주세요.",
        "전체 건축 관련 법규에서 용적률 완화에 관해서 알려주세요. 단, 관련된 법령의 이름이나 조항 번호를 포함하고 법령 내용을 인용하는 방식으로 설명해주세요.",
    ]
